...
router.route('/admin/user/:id')
                    .get(isAuthentcatedUser, authorizeRoles('admin'), getUserDetails)
                    .put(isAuthentcatedUser, authorizeRoles('admin'), updateUser)
                    .delete(isAuthentcatedUser, authorizeRoles('admin'), deleteUser)
